/*以下为求解 R=C6_CON/a（a,b）时，表面吸附 C2 和 C6 组分覆盖率随时间的变化*/
/*定义头文件*/
#include <stdio.h>
#include <stdlib.h>
...
double C2_CON = 0.5;          //C2浓度
double C6_CON = 7.5;         //C6浓度
...
{  /*定义变量*/
	...
	for(n=0;n<MC_Time;n++)
	{
		...
		empty[n]=Empty_NUM;C2[n]=C2_NUM;C6[n]=C6_NUM;       /*取每 MCS 的第一次循环作为这次 MCS 内的表面状态输出*/
