...
{  /*定义变量*/
	...
	clock_t start, finish, whole1 = 0, whole2 = 0, whole3 = 0, whole4 = 0, whole5 = 0, whole6 = 0, whole7 = 0;

	/*总循环 MC_Time 次，PP 的值为蒙特卡罗时间 MCS*/
	int Empty_NUM=MAT_SIZE,C2_NUM=0,C6_NUM=0;

	clock_t start1, finish1;
	clock_t start0, finish0, whole0 = 0;
	start0 = clock();
	for(n=0;n<MC_Time;n++)
	{
		//start1 = clock();
