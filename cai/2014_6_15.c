/*以下为求解 R=b/a=6（a=1,b=6）时，表面吸附 C2 和 C6 组分覆盖率随时间的变化*/
/*定义头文件*/
#include <stdio.h>
#include <stdlib.h>
...
{  /*定义变量*/
	...
	for(n=0;n<pp;n++)
	{
		...
		for(nn=0;nn<m*m;nn++)
		{
			...
			/*以下是相关计算式*/
			aa=10*1*0.16*0.443*n1/2500;                                          /* C2 吸附速率*/
			ba=509.36*6*0.16*(0.443*n1/2500)*(0.443*n1/2500)*(0.443*n1/2500);/* C6 吸附速率*/
...
at 存储小分子脱附数，
bt 存储大分子脱附数*/
		tor[n]=nr;ar[n]=nad;br[n]=nbd;ax[n]=nax;bx[n]=nbx;at[n]=nat;bt[n]=nbt;
